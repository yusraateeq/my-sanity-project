...
interface IBlogDetails {
  name: string;
  subheading: string;
  content: any; // Update this to 'any' or 'TypedObject | TypedObject[]' for more precise typing
  poster?: {
    asset: {
      _ref: string;
    };
  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg text-gray-700 mt-8">
          {Array.isArray(blog.content) || typeof blog.content === 'object' ? (
            <PortableText value={blog.content} />
          ) : (
            <p>{blog.content}</p> // If content is a string, render as plain text
          )}
        </div>
